...
public class ImageClassifierONNX : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        string modelDir = "ONNXModels/mobilenetv2_050";
        //string modelDir = "ONNXModels/mobilenetv3_large_100";
        //string modelDir = "ONNXModels/resnet34";
        string modelName = "asl-and-some-words-mobilenetv2_050.onnx";
        //string modelName = "asl-and-some-words-mobilenetv3_large_100.onnx";
        //string modelName = "asl-and-some-words-resnet34.onnx";
        string modelPath = $"{Application.streamingAssetsPath}/{modelDir}/{modelName}";
        string exec_provider = "wasm";
        //string exec_provider = "webgl";
        WebGLPluginJS.InitOrtSession(modelPath, exec_provider, mean, std_dev);
    }
